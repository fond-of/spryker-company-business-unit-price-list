...
namespace FondOfSpryker\Zed\CompanyBusinessUnitPriceList\Communication\Plugin\CompanyBusinessUnitExtension;

use Codeception\Test\Unit;
use FondOfSpryker\Zed\CompanyBusinessUnitPriceList\Business\CompanyBusinessUnitPriceListFacade;
use Generated\Shared\Transfer\CompanyBusinessUnitTransfer;

class PriceListCompanyBusinessUnitExpanderPluginTest extends Unit
{
    /**
     * @var \FondOfSpryker\Zed\CompanyBusinessUnitPriceList\Communication\Plugin\CompanyBusinessUnitExtension\PriceListCompanyBusinessUnitExpanderPlugin
     */
    protected $priceListCompanyBusinessUnitExpanderPlugin;

    /**
     * @var \PHPUnit\Framework\MockObject\MockObject|\FondOfSpryker\Zed\CompanyBusinessUnitPriceList\Business\CompanyBusinessUnitPriceListFacade
     */
